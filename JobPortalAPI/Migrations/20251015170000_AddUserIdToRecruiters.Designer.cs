...
namespace db_apis.Migrations
{
    ...
    [Migration("20251015170000_AddUserIdToRecruiters")]
    partial class AddUserIdToRecruiters
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPortalAPI.Models.Application", b =>
            {
                ...
                b.HasOne("JobPortalAPI.Models.Job", null)
                    .WithMany()
                    .HasForeignKey("JobID")
                    .OnDelete(DeleteBehavior.Cascade);
            });
            ...
            modelBuilder.Entity("JobPortalAPI.Models.Company", b =>
            {
                b.HasOne("JobPortalAPI.Models.IndustryLookup", null)
                    .WithMany()
            ...
            modelBuilder.Entity("JobPortalAPI.Models.Job", b =>
            {
                ...
                b.HasOne("JobPortalAPI.Models.Recruiter", null)
                    .WithMany()
